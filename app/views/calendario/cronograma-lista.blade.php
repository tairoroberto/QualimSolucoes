@extends('layout.layout')
  ...
  @section('head')
    ...
    function enviar(id){
      formNutricionistaCronograma.nutricionista_id.value = id;
      formNutricionistaCronograma.submit();
    }
    </script>
  @stop
    ...
    @section('content')
        ...
        <h3><span class="semi-bold">Lista de cronogramas</span></h3>
      </div>
            <div class="span12">
              <div class="grid simple">
              {{Form::open(array('id'=>'formNutricionistaCronograma','url'=>'cronograma-detalhe'))}}
                       ...
                       @foreach ($nutricionistas as $nutricionista) 
                          ...
                          <tr >
                             <td onclick="enviar({{$nutricionista->id}})">
                               <a href="#" title="Visualizar cronograma de consultora">
                                <i class="fa fa-paste"> 
                                </i>                                      
                                </a>  
                              </td>
