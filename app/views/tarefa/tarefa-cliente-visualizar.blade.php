...
<head>
    ...
    <link href="packages/assets/plugins/jquery-slider/css/jquery.sidr.light.css" rel="stylesheet" type="text/css"
          media="screen"/>
    ...
    <link href="packages/assets/plugins/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet"
          type="text/css"/>
    <link rel="stylesheet"
          href="packages/assets/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"/>
                ...
                <div class="tabbable tabs-left">
                    ...
                    <div class="tab-content">
                        ...
                        @foreach ($tarefas2 as $tarefa2)
                            ...
                            <div class="tab-pane <?php if ($cont2 == 0) {
                                echo "active";
                            } ?>" id="tabela{{$tarefa2->id}}">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!--INICIO DA AÇÂO-->
                                        <div class=" col-md-4 btn-group"><a
                                                    class="btn btn-white dropdown-toggle btn-demo-space"
                                                    data-toggle="dropdown" href="#"> Ações<span class="caret"></span>
                                            </a>
                                    ...
                                    <div class="col-md-3">
                                        <p class="light"><strong>Duração
                                                Prevista:</strong> <?php echo $duracao / $segundos; ?> dias</p>
...
<!-- Begin Modal -->
<div class="modal fade" id="modalTarefaPedir" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                           <textarea rows="4" cols="50" name="motivoPrazo" placeholder="Informe o motivo..."
                                     style="width:100%">
                           </textarea>
...
<div class="modal fade" id="modalTarefaConceder" tabindex="-1" role="dialog" aria-labelledby="myModalDataLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<script type="text/javascript"
        src="packages/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
