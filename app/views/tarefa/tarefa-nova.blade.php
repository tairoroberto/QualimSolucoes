...
@section('content')
  ...
  <form name="formTarefas" id="formTarefas" method="POST" action="{{action('TarefasController@store')}}">
                ...
                <div class="col-md-24">
                  <div class="grid simple">
                   ...
                   <!--FIM DO CLONE DE TAREFAS-->
                    ...
                    <div class="col-md-2">
                     <button class="btn btn-primary btn-cons" id="btnAdicionar" type="button" onclick="criarCampoTarefa();insereSelect();mascaraData();">Adicionar tarefa </button>
                    </div>
                    </div>
