                ...
                <table class='table_scale' width='600' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#ecf0f1' style='padding:0; margin: 0;'>
                    <tr>
                        <td class='td_scale' width='600' height='30' bgcolor='#ecf0f1' align='left' valign='middle' style='height: 30px; padding-left:0px; padding-bottom:10px;  font-size:0 ; color:#686868; font-family: Arial,sans-serif; line-height: 0; '>
                            ...
                            <p><a href='http://www.qualimsolucoes.com/' target='_blank'><br /><br />
                                    <img src='http://www.nowsolucoes.com.br/qualim/public/packages/assets/img/Logo-Qualin-interno.png' width='180' height='50' /></a></p>
                            <p>
                        </td>
                    </tr>
                </table>
                ...
                <table class='table_scale' width='' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#ffffff' style='padding:0; margin: 0;'>
                    <tr>
                        <td class='full_width' align='left' valign='top' width='600' bgcolor='#ffffff' style=''><table width='100%'>
                                <!-- START OF IMAGE-->
                                <tr>
                                    <td valign='top' style='padding: 0px; font-size:13px ; color:#727272; font-family: Arial,sans-serif; line-height: 23px; '><img class='img_scale' src='http://www.nowsolucoes.com.br/qualim/public/packages/assets/img/Logo-Qualin-login.png' width='600' height='200' alt='image' border='0' style='display: block;' /> </td>
                                </tr>
                                <!-- END OF IMAGE-->
                                <!-- START OF HEADING-->
                                <tr>
                                    <td align='left' valign='top' style='padding-top: 23px; padding-right: 30px; padding-bottom: 0; padding-left: 30px; font-size:16px ; line-height: 34px; text-transform: none; color:#1f2122; font-family: Arial,sans-serif; '> Olá {{$nutricionista->name}}</td>
                                </tr>
                                <!-- END OF HEADING-->
                                <!-- START OF TEXT-->
                                <tr>
