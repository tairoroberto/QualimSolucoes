...
@section('head')
    ...
    <link rel="stylesheet" type="text/css"
          href="packages/assets/plugins/bootstrap-multiselect/css/bootstrap-multiselect.css">
    <script type="text/javascript"
            src="packages/assets/plugins/bootstrap-multiselect/js/bootstrap-multiselect.js"></script>
                        ...
                        <div class="row column-seperation">
                            <div class="col-md-24">
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        <input name="razaoSocial" id="razaoSocial" type="text" class="form-control"
                                               placeholder="Razão social" value="{{Input::old('razaoSocial')}}">
                                    </div>

                                    <div class="col-md-6">
                                        <input name="nomeFantasia" id="nomeFantasia" type="text" class="form-control"
                                               placeholder="Nome fantasia" value="{{Input::old('nomeFantasia')}}">
                                    </div>


                                    <div class="col-md-3">
                                        <input name="cnpj" id="cnpj" type="text" class="form-control"
                                               placeholder="CNPJ " value="{{Input::old('cnpj')}}"
                                               onblur="chamaModal();">
                                    </div>

                                    <div class="col-md-6">
                                        <input name="endereco" id="endereco" type="text" class="form-control"
                                               placeholder="Endereço " value="{{Input::old('endereco')}}">
                                    </div>
                                    <div class="col-md-3">
                                        <input name="numero" id="numero" type="text" class="form-control"
                                               placeholder="Numero " value="{{Input::old('numero')}}">
                                    </div>

                                    <div class="col-md-2">
                                        <input name="bairro" id="bairro" type="text" class="form-control"
                                               placeholder="Bairro" value="{{Input::old('bairro')}}">
                                    </div>
                                    <div class="col-md-10">
                                        <input name="complemento" id="complemento" type="text" class="form-control"
                                               placeholder="Complemento" value="{{Input::old('complemento')}}">
                                    </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-5">
                                        <input name="cidade" id="cidade" type="text" class="form-control"
                                               placeholder="Municipio " value="{{Input::old('cidade')}}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <input name="telefone" id="telefone" type="text" class="form-control"
                                               placeholder="Telefone empresa" value="{{Input::old('telefone')}}">
                                    </div>
                                </div>
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        <input name="contato" id="contato" type="text" class="form-control"
                                               placeholder="Nome do contato " value="{{Input::old('contato')}}">
                                    </div>

                                    <div class="col-md-3">
                                        <input name="telefone_contato" id="telefone_contato" type="text"
                                               class="form-control" placeholder="Telefone do contato"
                                               value="{{Input::old('telefone_contato')}}">
                                    </div>

                                    <div class="col-md-3">
                                        <input name="celular_contato" id="celular_contato" type="text"
                                               class="form-control" placeholder="Celular do contato"
                                               value="{{Input::old('celular_contato')}}">
                                    </div>
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="email_contato" id="email_contato" type="text" class="form-control"
                                               placeholder="Email do contato " value="{{Input::old('email_contato')}}">
                                    </div>
                                    <div class="col-md-4">
                                        <select name="nutricionista_id[]" id="nutricionista_id" multiple
                                    ...
                                    <div class="col-md-6">
                                        <input name="email" id="email" type="text" class="form-control"
                                               placeholder="Email para Login do cliente"
                                               value="{{Input::old('email')}}">
                                    </div>

                                    <div class="col-md-3">
                                        <input name="senha" id="senha" type="password" class="form-control"
                                               placeholder="Senha " value="{{Input::old('senha')}}">
                                    </div>

                                    <div class="col-md-3">
                                        <input name="senha_confirmation" id="senha_confirmation" type="password"
                                               class="form-control" placeholder="Confirma senha "
                                               value="{{Input::old('senha_confirmation')}}">
                                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                        <img src="<?php echo $params['captchaBase64']; ?>" id="imgCaptcha"
                                             name="imgCaptcha" class='img-responsive' width="200" height="100"><br>

                                        <input type='text' class='form-control' name='captcha' id='captcha'>
                                        <!--  <input type='hidden' class='form-control' name='viewstate' id='viewstate' value="<?php //echo $params['viewstate']; ?>"> -->
                                        <input type='hidden' class='form-control' name='cookie' id='cookie'
                                               value="<?php echo $params['cookie']; ?>">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar
                                        </button>
                                        <button type="button" id="btnBuscarDados" class="btn btn-primary"
                                                data-dismiss="modal">Buscar dados de cliente
                                        </button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
