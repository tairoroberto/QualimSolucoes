              ...
              <div class="row">
                ...
                @endif
                  ...
                  <div class="grid simple">
                    ...
                    {{Form::open(array('action' => 'NutricionistasController@atualizaContaNutricionista', 'files' => 'true'))}}

                        <?php $nutricionista = Nutricionista::find(Auth::user()->get()->id); ?>
                      ...
                      <div class="col-md-6">
                          <input name="nome" id="nome" type="text"  class="form-control" placeholder="Nome"
                                 value="<?php if (isset($nutricionista->name)){echo $nutricionista->name;}elseif (Input::old("nome")){
                                     echo Input::old("nome");
                                 }?>">
                      </div>
                      <div class="col-md-3">
                        ...
                        <input name="senha" id="senha" type="password"  class="form-control" placeholder="Senha"
                               value="<?php if (isset($nutricionista->password)){echo $nutricionista->password;}elseif (Input::old("senha")){
                                   echo Input::old("senha");
                               }?>">
                      </div>
                      <div class="col-md-3">
                        <input name="senha_confirmation" id="senha_confirmation" type="password"  class="form-control" placeholder="Confirma Senha"
                               value="<?php if (isset($nutricionista->password_confirmation)){echo $nutricionista->password_confirmation;}elseif (Input::old("senha_confirmation")){
                    ...
                    <div class="row form-row">
                        <div class="col-md-3">
                            <input name="cep" id="cep" type="text"  class="form-control" placeholder="CEP "
                                   value="<?php if (isset($nutricionista->postal_code)){echo $nutricionista->postal_code;}elseif (Input::old("cep")){
                                       echo Input::old("cep");
                                   }?>" onblur="buscarCep()">
                        </div>
                        ...
                        <div class="col-md-5">
                            <input name="bairro" id="bairro" type="text"  class="form-control" placeholder="Bairro"
                                   value="<?php if (isset($nutricionista->district)){echo $nutricionista->district;}elseif (Input::old("bairro")){
                                       echo Input::old("bairro");
                                   }?>">
                        </div>

                        <div class="col-md-4">
                            <input name="cidade" id="cidade" type="text"  class="form-control" placeholder="Municipio "
                                   value="<?php if (isset($nutricionista->city)){echo $nutricionista->city;}elseif (Input::old("cidade")){
                    ...
                    <div class="row form-row">                      
                      <div class="col-md-12">
                        <input name="endereco" id="endereco" type="text"  class="form-control" placeholder="Endereço "
                               value="<?php if (isset($nutricionista->address)){echo $nutricionista->address;}elseif (Input::old("endereco")){
                    ...
                    <div class="row form-row">
                      <div class="col-md-3">
                          ...
                          <input name="telefone" id="telefone" type="text"  class="form-control" placeholder="Telefone"
                                 value="<?php if (isset($nutricionista->telephone)){echo $nutricionista->telephone;}elseif (Input::old("telefone")){
                     ...
                     <div class="col-md-3">
                        ...
                        <input name="celular" id="celular" type="text"  class="form-control" placeholder="Celular "
                               value="<?php if (isset($nutricionista->celphone)){echo $nutricionista->celphone;}elseif (Input::old("celular")){
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="email" id="email" type="text"  class="form-control" placeholder="E-mail "
                               value="<?php if (isset($nutricionista->email)){echo $nutricionista->email;}elseif (Input::old("email")){
                    ...
                    <input type="hidden" id="nutricionista_id" name="nutricionista_id"
                       value="<?php if (isset($nutricionista->id)){echo $nutricionista->id;}elseif (Input::old("nutricionista_id")){
